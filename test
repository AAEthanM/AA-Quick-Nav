...
(function() {
    ...
    const hBorder = 5;
    const leftPush = -4;
    const defAttr = "font-family:Wingdings;background:#F0F0F0;box-sizing:unset;flex-wrap:none;float:left;font-size:12px;position:absolute;cursor:pointer;padding:0px;z-index:1500;min-width:0px;width:"+hScalingAttr+"px;height:"+vScalingAttr+"px;";
